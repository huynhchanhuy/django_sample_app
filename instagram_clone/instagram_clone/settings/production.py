...
if not settings.DEBUG:
	...
	STATIC_ROOT = '/home/ducvanst/webapps/imagesocial_static/'
	#os.path.join(os.path.dirname(BASE_DIR),"static_env","static_root") #Link to static files

	MEDIA_URL = '/media/'
	MEDIA_ROOT = '/home/ducvanst/webapps/imagesocial_media/'
	#os.path.join(os.path.dirname(BASE_DIR),"static_env","media_root")
